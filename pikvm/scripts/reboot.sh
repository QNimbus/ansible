...
echo 'ansible pikvm --become --module-name shell --args "/usr/bin/reboot --poweroff now" --background 60 --poll 0 --one-line'

$ANSIBLE pikvm --become --module-name shell --args "/usr/bin/reboot --poweroff now" --background 60 --poll 0 --one-line