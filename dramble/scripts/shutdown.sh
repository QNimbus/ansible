...
echo 'ansible dramble --become --module-name shell --args "/usr/sbin/shutdown --poweroff now" --background 60 --poll 0 --one-line'

$ANSIBLE dramble --become --module-name shell --args "/usr/sbin/shutdown --poweroff now" --background 60 --poll 0 --one-line
